    ...
    <form action="{{route('subscribers.update', $subscriber)}}" method="POST">
        ...
        <div class="form-row mx-0">
            <div class="form-group col-md-6 pl-0">
                ...
                <input type="text" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" name="email" required value="{{$subscriber->email}}">
                @if ($errors->has('email'))
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-md">Update subscriber</button>
        </div>
    </form>
</div>
@endsection
